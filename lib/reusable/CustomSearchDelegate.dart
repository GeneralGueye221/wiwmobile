...
class CustomSearchDelegate extends StatefulWidget {
  ...
  CustomSearchDelegate({this.user,this.isUser,});
  @override
...
class _CustomSearchDelegateState extends State<CustomSearchDelegate> {
  ...
  String url = "https://wiwsport.com/wp-json/wp/v2/posts?_embed&_fields=title,slug,content,date,categories,link,_links.wp:featuredmedia,_links.wp:term";
  String searching = " ";
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        ...
                        builder: (BuildContext context) {
                          return DetailsPage(post:posts[index], user: widget.user, isConnect: widget.isUser);
                        },
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                            settings: RouteSettings(name: ''),
                            builder: (BuildContext context) {
                              return DetailsPage(post:articles[index], user: widget.user, isConnect: widget.isUser);
                            },
                            fullscreenDialog: true),
                      );
                    },
