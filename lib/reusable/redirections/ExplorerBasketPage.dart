...
class ExplorerBasketPage extends StatefulWidget {
  @override
  _ExplorerBasketPageState createState() => _ExplorerBasketPageState();
}

class _ExplorerBasketPageState extends State<ExplorerBasketPage> {
