...
class ExplorerFootPage extends StatefulWidget {
  @override
  _ExplorerFootPageState createState() => _ExplorerFootPageState();
}

class _ExplorerFootPageState extends State<ExplorerFootPage> {
